...
브라우저에서 비교·후속 질문과 대화 초기화를 확인했다. 생성 답변의 표현은 달라질 수 있으므로 과목 집합과 근거 본문을 중심으로 확인한다. 서버 재시작 후 [GitHub의 독립 접속 검사](https://github.com/JunH14/sugang-mate/actions/runs/34437384036)에서도 로그인·API 키 없이 근거 질문·시간표·범위 밖 안내 3개가 모두 통과했다. [데이터 준비·배포 안내](deployment.md)
