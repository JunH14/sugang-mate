...
<details>
<summary>실제 25개 과목 데모 화면 보기</summary>
<p align="center">
  <img src="docs/assets/demo-collected.png" alt="실제 수집 과목 25개와 Gemini 연결 상태를 보여주는 공개 데모의 모바일 화면" width="340">
</p>
</details>
...
| 검증 | 확인된 결과 |
|---|---|
| 자동 테스트 | 설정·캐시·대화 격리·공개 요청 제한·화면 등 **98개 통과**: [검사 기록](evaluation/release-checks.json) |
