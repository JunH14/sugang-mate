...
| 실제 25개 공개 서버 | 별도 GitHub 컴퓨터에서 로그인·방문자 API 키 없이 **4개 검사 통과**, 실제 Gemini 생성 포함: [최신 확인 기록](evaluation/chat-ui-checks.json) |
| 채팅 화면 | PC·모바일 화면, 답변별 근거, 과목 전환·이어 묻기·새 대화 확인: [화면 검사 기록](evaluation/chat-ui-checks.json) |
